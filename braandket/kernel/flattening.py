...
class Schrodinger(Static, Flattening, abc.ABC):
    @classmethod
    def init_model(cls, model, value):
...
class SchrodingerPsiPade(Schrodinger, Static, FlatteningPsi):
...
class SchrodingerRhoPade(Schrodinger, Static, FlatteningRho):
    def __init__(self, model, time, value):
        super().__init__(model, time, value)
